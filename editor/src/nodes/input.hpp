...
struct InputNode : ExpressionNode
{
    ...
    {
        repo.add<InputNode>({"Inputs", "input_time", "Time", {}, {{"", Types::scalar}}}, Types::scalar, "P_time", true);

        repo.add<InputNode>({"Inputs", "uv", "UV", {}, {{"", Types::vec2}}}, Types::vec2, "gl_TexCoord[0].xy", false);
    }
};